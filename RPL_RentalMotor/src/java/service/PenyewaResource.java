...
public class PenyewaResource {
    ...
    /**
     * Creates a new instance of PenyewaResource
     */
...
//    }
    ...
    @Path("searchPenyewa")
    @Produces(MediaType.APPLICATION_JSON)
    public String getJson(@QueryParam("noIdentitas") String noIdentitas) {
        return new Gson().toJson(new penyewaHelper().searchPenyewa(noIdentitas));
    }
}
